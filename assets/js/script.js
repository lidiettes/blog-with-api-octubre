    ...
    fetch("https://jsonplaceholder.typicode.com/posts")
        ...
        .then(data => {
            for (let i = 0; i < 15; i++) {
                ...
                post.innerHTML = `
                <div class="shadow-lg p-2 mb-2 bg-body rounded w-70 main-container"  >
                    <div class="row row-cols-1 " >
                        <div id= "main-title" class="col" class="row" type="button"  class="btn btn-primary" data-bs-toggle="modal"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <hr>
                                        <div id="modal-comments" > <p class="p-comments">Comments</p> </div>
                                    </div>
...
function getComments() {
    ...
    .then(response => response.json())
    .then(data => {
        const containerComments = document.getElementById("modal-comments")
            for (let i = 0; i < 8; i++) {
